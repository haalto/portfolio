  ...
  return (
    <div>
      ...
      <Project 
        ...
        description="Template for developing full stack application with Postgres, Express, ReactJS, NodeJS and TypeScript. Just add .env-file and run docker-compose up and you are ready to start developing!"
        techs={['ReactJS, NodeJS', 'Postgres, TypeScipt', 'Docker']} 
        liveUrl="" 
